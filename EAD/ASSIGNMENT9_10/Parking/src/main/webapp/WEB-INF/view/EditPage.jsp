...
<body>
	<div align="center" id="reg">
		<form:form modelAttribute="employeeDTO" action="EditPage">
		<form:errors cssClass="text-danger"></form:errors>
			...
			<table>
				...
				<tr>
					<td>Password :</td>
					<td><form:input type="password" path="password" value="${employeeDTO.password}"/></td>
					<td><form:errors path="password" cssClass="text-danger"></form:errors>
				</tr>
				<tr>
					<td>Confirm Password :</td>
					<td><form:password path="repass" value="${employeeDTO.password}"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Organization :</td>
					<td><form:select path="org" value="${employeeDTO.org}">
