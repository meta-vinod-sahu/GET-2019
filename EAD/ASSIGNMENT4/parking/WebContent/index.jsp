    ...
    <div style="margin-top:0px">
            ...
            <table cellpadding="20"> 
                    <tr>
                        ...
                        <td><a href="#"  id="signup" onclick="return onClickShowForm(this.id)">Sign-up</a></td>
                        <td><a href="#"  id="vh"   onclick="return onClickShowForm(this.id)">Vehicle form</a></td>
                    </tr>
            </table>
    </div>
    <!--Add Vehicle form-->
    <div id ="vehicle_div" style="display: none"> <!---->
            <form action="index.html" name = "add_vehicle_form" method="POST" onsubmit="return validateVehicleForm()">
                    <table border="0px" align="center" cellspacing="0px" width="60%"  cellpadding="10">
                            ...
                            <tr>
                                    ...
                                    <td width="10%"><input type="text" value="3333"disabled name="vehicle_emp_id" id="vehicle_emp_id" placeholder="Enter Employee Id"onkeypress="return removeError(id)" ></td>
                ...
                <table border="0px" align="center" cellspacing="0px" width="60%"  cellpadding="10">
                        ...
                        <tr>
                            ...
                            <td width="10%"><select name="organization_type" id="organization_type" onchange="setRateOfVehicle()">
                                       <option name="Car" value="TCS">TCS</option>
