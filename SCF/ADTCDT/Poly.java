/**
 * Implement the immutable class Poly using an array to represent single variable polynomial. Note that you should be storing only those terms of
 * polynomial that have non zero coefficient. You can assume that the coefficients are integers
 * It should support methods like -
 * evaluate(float) - return the value of the polynomial for the given value of
 * the variable degree() - return the degree of the polynomial
 ...
 * You may use private helper methods. addPoly() and multiplyPoly() can make
 * assumptions about size of the resulting polynomial to decide about the size
...
public final class Poly {
	...
	/**
	 * @param index is an integer value that is used to see if there existanyX^index in the equation
	 * @returns return an integer value that indicate that the power of x existin the equation
	 */
	...
	/**
	 * @param p1and 
	 * @param p2 are the two objects of Poly class representing two polynomial equation
